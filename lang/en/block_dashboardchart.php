...
/**
 * Language strings for block_dashboardchart.
 *
...
$string['color'] = 'Colour of the bar';
$string['color_desc'] = 'Choose the colour of the chart.';
$string['country_desc'] = 'Country name';
$string['country_title'] = 'Students enrolled by country';
$string['courseno'] = 'Number of courses';
...
$string['dashboardcharttype:enrollment'] = 'Enrolment by country';
...
$string['dashboardcharttype:loginusers'] = 'Top and bottom users by logins';
$string['dashboardcharttype:select'] = 'Select';
$string['datalimitlabel'] = 'Data limit';
...
$string['logins'] = 'User logins';
$string['loginusers'] = 'Logins per user';
...
$string['studentpercourse'] = 'Students per course';
